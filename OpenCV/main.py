...
def detect_contours(preprocessed_image, threshold_value):
    ...
    cv2.imwrite('output/image2.jpeg', thresh)
...
# Load images
image_no_darts = cv2.imread('input/IMG_7290.jpeg')
image_with_darts = cv2.imread('input/IMG_7291.jpeg')
#resize images
...
# Display the result
cv2.imwrite('output/image1.jpeg', image_with_darts)
cv2.waitKey(0)
